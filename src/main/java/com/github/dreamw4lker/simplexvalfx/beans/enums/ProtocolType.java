...
public enum ProtocolType {
    ...
    CITOLOGY_GYNECOLOGICAL_EXAM("CITOLOGY_GYNECOLOGICAL_EXAM", "Протокол цитол. иссл. материала, полученного при профилактическом гинекологическом осмотре, скрининге", "1.2.643.5.1.13.13.15.136", List.of(1)),
    EXPERT_OPINION("EXPERT_OPINION", "Медицинская справка (врачебное профессионально-консультативное заключение) (ф. 086/у)", "1.2.643.5.1.13.13.15.45", List.of(3)),
    CE("CE", "Протокол копрологического исследования", "1.2.643.5.1.13.13.15.125", List.of(1));
